...
class Converter:
    def __init__(self):
        ...
        # In actual program this is blamk and is populated with user calculations
    ...
    def temp_convert(self, low):
        ...
        error = "Pink" # Pink background for when entry box has errors

        # assume that usere has not made a mistake...
...
class History:
    def __init__(self, partner, calc_history):
        ...
        # Generate string form list of calculations...
        history_string = " "
    ...
    def close_history(self, partner):
        # Put history buttin back to normal...
